// FRONTAGE — Massachusetts search (statewide), from MassGIS's standardized assessor
...
// units, zoning, and the latest sale (price + date).
...
export async function search(q) {
  const { town, propertyType, address, minValue, maxValue, minSqft, sinceYear, limit } = q;
  ...
  return {
    market: "ma", count: out.length, town: townName,
