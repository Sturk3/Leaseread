// FRONTAGE — Nashville / Davidson County, TN search, from Metro Nashville's daily-updated
...
// last SALE price + date (→ years owned), and acreage. Free, no key.
...
export const BUILD = "nashville-v7-building-sf";
...
export async function search(q) {
  ...
  return {
    market: "nashville", count: out.length, county: "Davidson (Nashville)",
